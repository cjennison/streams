...
var Run.prototype.getSetting(){
  var setting = JSON.parse(fs.readFileSync(this.path+"/setting.json"));
  if(!setting) console.log("the run["+this.scriptname+" : "+this.id+"] has no setting yet/ or read file error");
  return setting;
}

//get the output result from r script
var Run.prototype.getResult(){
